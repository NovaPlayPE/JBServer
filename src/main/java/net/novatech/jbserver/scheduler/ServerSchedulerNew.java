...
public class ServerSchedulerNew {
	...
	/**
	 * Invoke runnable synchronously with main world thread, but delay it for given
	 * amount of time.
	 *
	 * @param runnable the runnable to be executed.
	...
	/**
	 * Invoke runnable synchronously with main world thread. Delay it for given
	 * amount of time and run it repeatedly with given repeat delay.
	 *
	 * @param runnable    the runnable to be executed.
	 * @param delay       amount of time for execution delay.
